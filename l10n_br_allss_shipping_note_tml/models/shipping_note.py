...
class ShippingNoteTml(models.Model):
    ...
    _allss_state_company = fields.Char('Sigla do Estado')
    _allss_state_partner = fields.Char('Sigla do Estado')
    ...
    def create_shipping_note(self):
        ...
        report = 'shipping_note_tml_2.action_shipping_note_report'
        # report = 'shipping_note_tml_2.print_shipping_note'
