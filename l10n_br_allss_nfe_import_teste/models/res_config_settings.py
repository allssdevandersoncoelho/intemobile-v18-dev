...
class L10nBrAllssResConfigSettings(models.TransientModel):
    ...
    l10n_br_allss_product_sequence_id = fields.Many2one(
        ...
        default=lambda self: (
            self.env.ref(
                "l10n_br_allss_nfe_import_teste.sequence_l10n_br_allss_nfe_import_teste_product",
    ...
    l10n_br_allss_nfe_import_teste_nfe_mde_limit_for_process = fields.Integer(
    ...
    def get_values(self):
        ...
        res.update(
            ...
            l10n_br_allss_nfe_import_teste_nfe_mde_limit_for_process=int(params.get_param(
                'l10n_br_allss_nfe_import_teste.l10n_br_allss_nfe_import_teste_nfe_mde_limit_for_process', default=50)),
        )
        return res
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param(
            'l10n_br_allss_nfe_import_teste.l10n_br_allss_nfe_import_teste_nfe_mde_limit_for_process',
            self.l10n_br_allss_nfe_import_teste_nfe_mde_limit_for_process or 50)
